 ...
 /*TODO*/ //     {
  ...
  /*TODO*/ //            {
   ...
   /*TODO*/ //           if (!silentident)
    ...
    /*TODO*/ //          for (i = 0; drivers_old[i]; i++)
    /*TODO*/ //          {
    /*TODO*/ //                  const struct RomModule *romp;

    /*TODO*/ //                  romp = drivers_old[i].rom;
   ...
   /*TODO*/ //                           if (romp.name && romp.name != (char *)-1 && checksum == romp.crc)
     ...
     /*TODO*/ //                                 {
      /*TODO*/ //                                        if (found != 0)
      /*TODO*/ //                                                printf("             ");
     /*TODO*/ //                                         printf("= %-12s  %s\n",romp.name,drivers_old[i].description);
     /*TODO*/ //                                 }
     /*TODO*/ //                                 found++;
      /*TODO*/ //                        }
     /*TODO*/ //                         romp++;
...
/*TEMPHACK*/                 gamename=argv[1];//TO_BE_REMOVED (temp solution but works ok)
            ...
            {
                printf(settings.version +" (based on mame_old v%s)\n", new Object[] { build_version });

                    showdisclaimer();
                    printf("Usage:  java -jar arcadeflex_old.jar gamename [options]\n"
                           +         "        java -jar arcadeflex_old.jar -list      for a brief list of supported games\n"
                           +         "        java -jar arcadeflex_old.jar -listfull  for a full list of supported games\n\n"
...
/*TODO*/				 ) /*&& !strwildcmp(gamename, drivers_old[i].name)*/)
 ...
 /*TODO*/ //					else
					...
					if (listclones!=0)
					{
 /*TODO*/ //						if (strchr(drivers_old[i].description,'('))
 /*TODO*/ //							printf(" %s",strchr(drivers_old[i].description,'('));
					}
					printf("\"\n");
				}
				i++;
...
/*TODO*/				 ) /*&& !strwildcmp(gamename, drivers_old[i].name)*/)
				{
/*TODO*/ //					for( j = 0; drivers_old[i].drv.sound_old[j].sound_type && j < MAX_SOUND; j++ )
/*TODO*/ //					{
/*TODO*/ //						const char **samplenames;
/*TODO*/ //						if( drivers_old[i].drv.sound_old[j].sound_type != SOUND_SAMPLES )
/*TODO*/ //							continue;
/*TODO*/ //						samplenames = ((struct Samplesinterface *)drivers_old[i].drv.sound_old[j].sound_interface).samplenames;
/*TODO*/ //						if (samplenames != 0 && samplenames[0] != 0)
/*TODO*/ //						{
/*TODO*/ //							printf("%-10s",drivers_old[i].name);
...
/*TODO*/ //					}
		...
		case LIST_LISTSAMPLES: /* game samples list */
			...
			{
				int k;
/*TODO*/ //				for( k = 0; gamedrv.drv.sound_old[k].sound_type && k < MAX_SOUND; k++ )
/*TODO*/ //				{
/*TODO*/ //					const char **samplenames;
/*TODO*/ //					if( gamedrv.drv.sound_old[k].sound_type != SOUND_SAMPLES )
/*TODO*/ //						continue;
/*TODO*/ //					samplenames = ((struct Samplesinterface *)gamedrv.drv.sound_old[k].sound_interface).samplenames;
/*TODO*/ //					if (samplenames != 0 && samplenames[0] != 0)
/*TODO*/ //					{
/*TODO*/ //						i = 0;
...
/*TODO*/ // 								drivers_old[i].name,
/*TODO*/ // 								(drivers_old[i].clone_of) ? drivers_old[i].clone_of.name : "",
/*TODO*/ // 								drivers_old[i].description);
/*TODO*/ // 					}
/*TODO*/ // 					fprintf(stderr,"%d%%\r",100 * (i+1) / total);
			...
			for(j=0;j<MAX_CPU;j++) printf("cpu_old %d    ",j+1);
			for(j=0;j<MAX_SOUND;j++) printf("sound_old %d     ",j+1);
			printf("name\n");
			printf("-------- ---------- ");
			...
			/* Let's cycle through the drivers_old */
...
/*TODO*/					) /*&& !strwildcmp(gamename, drivers_old[i].name)*/)
				{
					...
					/* source file (skip the leading "src/drivers_old/" */
		...
		case LIST_GAMELISTHEADER: /* GAMELIST.TXT */
			...
			+	"Sound - \"Partial\" means that sound_old support is either incomplete or not entirely\n"
			+	"  accurate. Note that, due to analog circuitry which is difficult to emulate,\n"
			+	"  sound_old may be significantly different from the real board. A common case is\n"
			+	"  the presence of low pass filters that make the real board sound_old less harsh\n"
			+	"  than the emulation.\n"
		...
		case LIST_GAMELIST: /* GAMELIST.TXT */
			...
			while (drivers[i]!=null)
			{
/*TODO*/ //				if ((listclones || drivers_old[i].clone_of == 0
/*TODO*/ //						|| (drivers_old[i].clone_of.flags & NOT_A_DRIVER)
/*TODO*/ //						) && !strwildcmp(gamename, drivers_old[i].name))
/*TODO*/ //				{
/*TODO*/ //					char name[200],name_ref[200];
/*TODO*/ //
/*TODO*/ //					strcpy(name,drivers_old[i].description);
/*TODO*/ //
...
/*TODO*/ //					{
/*TODO*/ //						if (strchr(drivers_old[i].description,'('))
/*TODO*/ //							strcat(name_ref,strchr(drivers_old[i].description,'('));
/*TODO*/ //					}
/*TODO*/ //
/*TODO*/ //					printf("| %-33.33s",name_ref);

/*TODO*/ //					if (drivers_old[i].flags & GAME_NOT_WORKING)
/*TODO*/ //					{
/*TODO*/ //						const struct GameDriver *maindrv;
/*TODO*/ //						int foundworking;

/*TODO*/ //						if (drivers_old[i].clone_of && !(drivers_old[i].clone_of.flags & NOT_A_DRIVER))
/*TODO*/ //							maindrv = drivers_old[i].clone_of;
/*TODO*/ //						else maindrv = drivers_old[i];

/*TODO*/ //						foundworking = 0;
/*TODO*/ //						j = 0;
/*TODO*/ //						while (drivers_old[j])
/*TODO*/ //						{
/*TODO*/ //							if (drivers_old[j] == maindrv || drivers_old[j].clone_of == maindrv)
/*TODO*/ //							{
/*TODO*/ //								if ((drivers_old[j].flags & GAME_NOT_WORKING) == 0)
/*TODO*/ //								{
/*TODO*/ //									foundworking = 1;
/*TODO*/ //									break;
/*TODO*/ //								}
...
/*TODO*/ //						printf("|  Yes  ");
/*TODO*/ //
/*TODO*/ //					if (drivers_old[i].flags & GAME_WRONG_COLORS)
/*TODO*/ //						printf("|   No  ");
/*TODO*/ //					else if (drivers_old[i].flags & GAME_IMPERFECT_COLORS)
/*TODO*/ //						printf("| Close ");
/*TODO*/ //					else
/*TODO*/ //						printf("|  Yes  ");
...
/*TODO*/ //							}
/*TODO*/ //						}
/*TODO*/ //						if (drivers_old[i].flags & GAME_NO_SOUND)
/*TODO*/ //							printf("|   No  ");
/*TODO*/ //						else if (drivers_old[i].flags & GAME_IMPERFECT_SOUND)
/*TODO*/ //						{
/*TODO*/ //							if (samplenames)
/*TODO*/ //								printf("|Part(2)");
/*TODO*/ //							else
...
/*TODO*/ //					}
/*TODO*/ //
/*TODO*/ //					if (drivers_old[i].flags & GAME_NO_COCKTAIL)
/*TODO*/ //						printf("|   No  ");
/*TODO*/ //					else
/*TODO*/ //						printf("|  Yes  ");
/*TODO*/ //
...
/*TODO*/ //				}
		...
		case LIST_LISTGAMES: /* list games, production year, manufacturer */
			...
			while (drivers[i]!=null)
			{
				if ((listclones!=0 || drivers[i].clone_of == null
						|| ((drivers[i].clone_of.flags & NOT_A_DRIVER)!=0)
/*TODO*/					) /*&& !strwildcmp(gamename, drivers_old[i].description)*/)
				{
     					       char name[]=new char[200];
...
/*TODO*/ 						/*(!strwildcmp(gamename,drivers_old[i].name)
/*TODO*/ 								/*|| !strwildcmp(gamename,drivers_old[i].clone_of.name))*/)
					printf("%-8s %-8s\n",drivers[i].name,drivers[i].clone_of.name);
				i++;
			}
			return 0;

		case LIST_WRONGORIENTATION: /* list drivers_old which incorrectly use the orientation and visible area fields */
			while (drivers[i]!=null)
			{
/*TODO*/ //				if ((drivers_old[i].drv.video_attributes & VIDEO_TYPE_VECTOR) == 0 &&
/*TODO*/ //						(drivers_old[i].clone_of == 0
/*TODO*/ //								|| (drivers_old[i].clone_of.flags & NOT_A_DRIVER)) &&
/*TODO*/ //						drivers_old[i].drv.visible_area.max_x - drivers_old[i].drv.visible_area.min_x + 1 <=
/*TODO*/ //						drivers_old[i].drv.visible_area.max_y - drivers_old[i].drv.visible_area.min_y + 1)
/*TODO*/ //				{
/*TODO*/ //					if (strcmp(drivers_old[i].name,"crater") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"mpatrol") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"troangel") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"travrusa") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"kungfum") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"battroad") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"vigilant") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"sonson") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"brkthru") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"darwin") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"exprraid") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"sidetrac") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"targ") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"spectar") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"venture") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"mtrap") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"pepper2") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"hardhat") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"fax") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"circus") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"robotbwl") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"crash") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"ripcord") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"starfire") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"fireone") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"renegade") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"battlane") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"megatack") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"killcom") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"challeng") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"kaos") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"formatz") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"bankp") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"liberatr") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"toki") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"stactics") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"sprint1") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"sprint2") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"nitedrvr") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"punchout") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"spnchout") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"armwrest") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"route16") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"stratvox") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"irobot") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"leprechn") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"starcrus") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"astrof") &&
/*TODO*/ //						strcmp(drivers_old[i].name,"tomahawk") &&
/*TODO*/ //						1)
/*TODO*/ //						printf("%s %dx%d\n",drivers_old[i].name,
/*TODO*/ //								drivers_old[i].drv.visible_area.max_x - drivers_old[i].drv.visible_area.min_x + 1,
/*TODO*/ //								drivers_old[i].drv.visible_area.max_y - drivers_old[i].drv.visible_area.min_y + 1);
/*TODO*/ //				}
		...
		case LIST_WRONGFPS: /* list drivers_old with too high frame rate */
/*TODO*/ //			while (drivers_old[i])
/*TODO*/ //			{
/*TODO*/ //				if ((drivers_old[i].drv.video_attributes & VIDEO_TYPE_VECTOR) == 0 &&
/*TODO*/ //						(drivers_old[i].clone_of == 0
/*TODO*/ //								|| (drivers_old[i].clone_of.flags & NOT_A_DRIVER)) &&
/*TODO*/ //						drivers_old[i].drv.frames_per_second > 57 &&
/*TODO*/ //						drivers_old[i].drv.visible_area.max_y - drivers_old[i].drv.visible_area.min_y + 1 > 244 &&
/*TODO*/ //						drivers_old[i].drv.visible_area.max_y - drivers_old[i].drv.visible_area.min_y + 1 <= 256)
/*TODO*/ //				{
/*TODO*/ //					printf("%s %dx%d %fHz\n",drivers_old[i].name,
/*TODO*/ //							drivers_old[i].drv.visible_area.max_x - drivers_old[i].drv.visible_area.min_x + 1,
/*TODO*/ //							drivers_old[i].drv.visible_area.max_y - drivers_old[i].drv.visible_area.min_y + 1,
/*TODO*/ //							drivers_old[i].drv.frames_per_second);
/*TODO*/ //				}
/*TODO*/ //				i++;
/*TODO*/ //			}
			return 0;
...
/*TODO*/ //			while (drivers_old[i])
/*TODO*/ //			{
/*TODO*/ //				if (!strwildcmp(gamename,drivers_old[i].name))
/*TODO*/ //					printf("%-8s %s\n",drivers_old[i].name,drivers_old[i].source_file);
/*TODO*/ //				i++;
/*TODO*/ //			}
			return 0;
...
/*TODO*/ //					while (drivers_old[i])
/*TODO*/ //					{
/*TODO*/ //						if (drivers_old[i].clone_of == 0 || (drivers_old[i].clone_of.flags & NOT_A_DRIVER))
/*TODO*/ //						{
/*TODO*/ //							const struct MachineDriver *x_driver = drivers_old[i].drv;
/*TODO*/ //							const struct MachineCPU *x_cpu = x_driver.cpu_old;
/*TODO*/ //
/*TODO*/ //							if (atoi(drivers_old[i].year) == year)
/*TODO*/ //							{
/*TODO*/ //                                                            //		for (j = 0;j < MAX_CPU;j++)
/*TODO*/ //                                                                        j = 0;	// count only the main cpu_old
...
/*TODO*/ //			print_mame_info( stdout, drivers_old );
			return 0;
	}
...
/*TODO*/ //				{
/*TODO*/ //					printf ("romset %s ", drivers_old[i].name);
/*TODO*/ //					if (drivers_old[i].clone_of && !(drivers_old[i].clone_of.flags & NOT_A_DRIVER))
/*TODO*/ //						printf ("[%s] ", drivers_old[i].clone_of.name);
/*TODO*/ //				}
/*TODO*/ //			}
...
/*TODO*/ //					goto nextloop;
/*TODO*/ //				}
/*TODO*/ //				printf ("sampleset %s ", drivers_old[i].name);
/*TODO*/ //			}
/*TODO*/ //
/*TODO*/ //			if (res == NOTFOUND)
/*TODO*/ //			{
