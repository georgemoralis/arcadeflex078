 ...
 * <p>
 * TODO:	remove the 1 analog device per port limitation support for inputports
 * producing interrupts support for extra "real" hardware (PC throttle's,
 * spinners etc)
 * <p>
 * *************************************************************************
 */
                        ...
                        if (seq_pressed(seq)) {
                            ...
                            if ((in[in_ptr].type & IPF_IMPULSE) != 0) {
                                ...
                                if (joyserial[joynum][joydir ^ 1] != 0) {
                                    ...
                                    if ((mru_dir == joydir) && stickyflag != 0)/* jmk */ {
                                        mask = 0;
                                    }
