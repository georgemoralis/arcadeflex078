...
/*TODO*///		new IO_WritePort( 0x7000, 0x7000, AY8910_write_port_0_w ),
/*TODO*///		new IO_WritePort( 0x8000, 0x8000, AY8910_control_port_0_w ),
...
/*TODO*///	);
	...
	public static MachineHandlerPtr machine_driver_kangaroo = new MachineHandlerPtr() {/* basic machine hardware */
...
/*TODO*///		MDRV_CPU_VBLANK_INT(irq0_line_hold,1);
		...
		MDRV_PALETTE_INIT(palette_init_kangaroo);
		MDRV_VIDEO_START(video_start_kangaroo);
		MDRV_VIDEO_UPDATE(video_update_kangaroo);
...
/*TODO*///	static RomLoadPtr rom_fnkyfish = new RomLoadPtr(){ public void handler(){ 
/*TODO*///		ROM_REGION( 0x14000, REGION_CPU1, 0 );
/*TODO*///		ROM_LOAD( "tvg_64.0",    0x0000,  0x1000, CRC(af728803) SHA1(1cbbf863f0eb4c759d6037ef9d9d0f4586b7b570) )
/*TODO*///		ROM_LOAD( "tvg_65.1",    0x1000,  0x1000, CRC(71959e6b) SHA1(7336cbf3eefd081cd657a56fb6a8fbdac1b51c2c) )
/*TODO*///		ROM_LOAD( "tvg_66.2",    0x2000,  0x1000, CRC(5ccf68d4) SHA1(c885df8b2b1bcb578ceab6615caf633dac02a5b2) )
/*TODO*///		ROM_LOAD( "tvg_67.3",    0x3000,  0x1000, CRC(938ff36f) SHA1(bf660217ff82d5850ab97238ed2e32199d04f8c9) )
/*TODO*///	
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2, 0 )
/*TODO*///		ROM_LOAD( "tvg_68.8",    0x0000,  0x1000, CRC(d36bb2be) SHA1(330160161857407fda62f16e7f43b8833744fd34) )
/*TODO*///	
/*TODO*///		ROM_REGION( 0x4000, REGION_GFX1, 0 )
/*TODO*///		ROM_LOAD( "tvg_69.v0",   0x0000, 0x1000, CRC(cd532d0b) SHA1(7a64f8bab1a0feafd53a4b81ac3b624a7c1bd26a) ) /* graphics ROMs */
/*TODO*///		ROM_LOAD( "tvg_71.v2",   0x1000, 0x1000, CRC(a59c9713) SHA1(60dafa3d5a70b7e727b7c4688f8f3125735c31ec) )
/*TODO*///		ROM_LOAD( "tvg_70.v1",   0x2000, 0x1000, CRC(fd308ef1) SHA1(d07f964cab875b0e47f3469fa5211684a5725dfe) )
/*TODO*///		ROM_LOAD( "tvg_72.v3",   0x3000, 0x1000, CRC(6ae9b584) SHA1(408d26f4cdcd2abf0667fdc9c6eae58c9052981d) )
/*TODO*///	ROM_END(); }}; 
	
	
	static RomLoadPtr rom_kangaroo = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x14000, REGION_CPU1, 0 );
		ROM_LOAD( "tvg_75.0",    0x0000, 0x1000, 0x0d18c581);// SHA1(0e0f89d644b79e887c53e5294783843ca7e875ba) )
		ROM_LOAD( "tvg_76.1",    0x1000, 0x1000, 0x5978d37a);// SHA1(684c1092de4a0927a03752903c86c3bbe99e868a) )
		ROM_LOAD( "tvg_77.2",    0x2000, 0x1000, 0x522d1097);// SHA1(09fe627a46d32df2e098d9fad7757f9d61bef41f) )
		ROM_LOAD( "tvg_78.3",    0x3000, 0x1000, 0x063da970);// SHA1(582ff21dd46c651f07a4846e0f8a7544a5891988) )
		ROM_LOAD( "tvg_79.4",    0x4000, 0x1000, 0x9e5cf8ca);// SHA1(015387f038c5670f88c9b22453d074bd9b2a129d) )
		ROM_LOAD( "tvg_80.5",    0x5000, 0x1000, 0x2fc18049);// SHA1(31fcac8eb660739a1672346136a1581a5ef20325) )
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );
		ROM_LOAD( "tvg_81.8",    0x0000, 0x1000, 0xfb449bfd);// SHA1(f593a0339f47e121736a927587132aeb52704557) )
	
		ROM_REGION( 0x0800, REGION_CPU3, 0 );  /* 8k for the MB8841 custom microcontroller (currently not emulated) */
		ROM_LOAD( "tvg_82.12",   0x0000, 0x0800, 0x57766f69);// SHA1(94a7a557d8325799523d5e1a88653a9a3fbe34f9) )
	
		ROM_REGION( 0x4000, REGION_GFX1, 0 );
		ROM_LOAD( "tvg_83.v0",   0x0000, 0x1000, 0xc0446ca6);// SHA1(fca6ba565051337c0198c93b7b8477632e0dd0b6) )
		ROM_LOAD( "tvg_85.v2",   0x1000, 0x1000, 0x72c52695);// SHA1(87f4715fbb7d509bd9cc4e71e2afb0d475bbac13) )
		ROM_LOAD( "tvg_84.v1",   0x2000, 0x1000, 0xe4cb26c2);// SHA1(5016db9d48fdcfb757618659d063b90862eb0e90) )
		ROM_LOAD( "tvg_86.v3",   0x3000, 0x1000, 0x9e6a599f);// SHA1(76b4eddb4efcd8189d8cc5962d8497e82885f212) )
	ROM_END(); }}; 
	
	
/*TODO*///	static RomLoadPtr rom_kangaroa = new RomLoadPtr(){ public void handler(){ 
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU1, 0 )
/*TODO*///		ROM_LOAD( "tvg_75.0",    0x0000, 0x1000, CRC(0d18c581) SHA1(0e0f89d644b79e887c53e5294783843ca7e875ba) )
/*TODO*///		ROM_LOAD( "tvg_76.1",    0x1000, 0x1000, CRC(5978d37a) SHA1(684c1092de4a0927a03752903c86c3bbe99e868a) )
/*TODO*///		ROM_LOAD( "tvg_77.2",    0x2000, 0x1000, CRC(522d1097) SHA1(09fe627a46d32df2e098d9fad7757f9d61bef41f) )
/*TODO*///		ROM_LOAD( "tvg_78.3",    0x3000, 0x1000, CRC(063da970) SHA1(582ff21dd46c651f07a4846e0f8a7544a5891988) )
/*TODO*///		ROM_LOAD( "tvg79.bin",   0x4000, 0x1000, CRC(82a26c7d) SHA1(09087552dbe4d27df79396072c0f9b916f78f89b) )
/*TODO*///		ROM_LOAD( "tvg80.bin",   0x5000, 0x1000, CRC(3dead542) SHA1(0b5d329b1ebbacc650d06289b4e080304e728ea7) )
/*TODO*///	
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2, 0 )
/*TODO*///		ROM_LOAD( "tvg_81.8",    0x0000, 0x1000, CRC(fb449bfd) SHA1(f593a0339f47e121736a927587132aeb52704557) )
/*TODO*///	
/*TODO*///		ROM_REGION( 0x0800, REGION_CPU3, 0 )  /* 8k for the MB8841 custom microcontroller (currently not emulated) */
/*TODO*///		ROM_LOAD( "tvg_82.12",   0x0000, 0x0800, CRC(57766f69) SHA1(94a7a557d8325799523d5e1a88653a9a3fbe34f9) )
/*TODO*///	
/*TODO*///		ROM_REGION( 0x4000, REGION_GFX1, 0 )
/*TODO*///		ROM_LOAD( "tvg_83.v0",   0x0000, 0x1000, CRC(c0446ca6) SHA1(fca6ba565051337c0198c93b7b8477632e0dd0b6) )
/*TODO*///		ROM_LOAD( "tvg_85.v2",   0x1000, 0x1000, CRC(72c52695) SHA1(87f4715fbb7d509bd9cc4e71e2afb0d475bbac13) )
/*TODO*///		ROM_LOAD( "tvg_84.v1",   0x2000, 0x1000, CRC(e4cb26c2) SHA1(5016db9d48fdcfb757618659d063b90862eb0e90) )
/*TODO*///		ROM_LOAD( "tvg_86.v3",   0x3000, 0x1000, CRC(9e6a599f) SHA1(76b4eddb4efcd8189d8cc5962d8497e82885f212) )
/*TODO*///	ROM_END(); }}; 
	
	
/*TODO*///	static RomLoadPtr rom_kangarob = new RomLoadPtr(){ public void handler(){ 
/*TODO*///		ROM_REGION( 0x14000, REGION_CPU1, 0 )
/*TODO*///		ROM_LOAD( "tvg_75.0",    0x0000, 0x1000, CRC(0d18c581) SHA1(0e0f89d644b79e887c53e5294783843ca7e875ba) )
/*TODO*///		ROM_LOAD( "tvg_76.1",    0x1000, 0x1000, CRC(5978d37a) SHA1(684c1092de4a0927a03752903c86c3bbe99e868a) )
/*TODO*///		ROM_LOAD( "tvg_77.2",    0x2000, 0x1000, CRC(522d1097) SHA1(09fe627a46d32df2e098d9fad7757f9d61bef41f) )
/*TODO*///		ROM_LOAD( "tvg_78.3",    0x3000, 0x1000, CRC(063da970) SHA1(582ff21dd46c651f07a4846e0f8a7544a5891988) )
/*TODO*///		ROM_LOAD( "tvg_79.4",    0x4000, 0x1000, CRC(9e5cf8ca) SHA1(015387f038c5670f88c9b22453d074bd9b2a129d) )
/*TODO*///		ROM_LOAD( "k6",          0x5000, 0x1000, CRC(7644504a) SHA1(7a8a4bd163d2cdf27390ab2ef65fb7fa6fc1a361) )
/*TODO*///	
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2, 0 )
/*TODO*///		ROM_LOAD( "tvg_81.8",    0x0000, 0x1000, CRC(fb449bfd) SHA1(f593a0339f47e121736a927587132aeb52704557) )
/*TODO*///	
...
/*TODO*///	GAME( 1981, fnkyfish, 0,        kangaroo, fnkyfish, 0, ROT90, "Sun Electronics", "Funky Fish" )
...
/*TODO*///	GAME( 1982, kangaroa, kangaroo, kangaroo, kangaroo, 0, ROT90, "[Sun Electronics] (Atari license)", "Kangaroo (Atari)" )
/*TODO*///	GAME( 1982, kangarob, kangaroo, kangaroo, kangaroo, 0, ROT90, "bootleg", "Kangaroo (bootleg)" )
}
