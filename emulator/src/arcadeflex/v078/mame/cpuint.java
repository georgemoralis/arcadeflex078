...
/*TODO*///	cpuint.c
/*TODO*///
/*TODO*///	Core multi-CPU interrupt engine.
/*TODO*///
/*TODO*///***************************************************************************/
/*TODO*///
...
/*TODO*///
/*TODO*////* ick, interrupt event queues */
/*TODO*///#define MAX_IRQ_EVENTS		256
/*TODO*///static INT32 irq_event_queue[MAX_CPU][MAX_IRQ_EVENTS];
/*TODO*///static int irq_event_index[MAX_CPU];
/*TODO*///
/*TODO*///
/*TODO*///
/*TODO*////*************************************
...
/*TODO*///		}
/*TODO*///		
/*TODO*///		/* reset the IRQ event queues */
/*TODO*///		irq_event_index[cpunum] = 0;
/*TODO*///	}
/*TODO*///
...
/*TODO*/// *************************************/
/*TODO*///
/*TODO*///static void cpu_empty_event_queue(int cpunum)
/*TODO*///{
/*TODO*///	int i;
/*TODO*///
...
/*TODO*///	for (i = 0; i < irq_event_index[cpunum]; i++)
/*TODO*///	{
/*TODO*///		INT32 irq_event = irq_event_queue[cpunum][i];
/*TODO*///		int state = irq_event & 0xff;
/*TODO*///		int irqline = (irq_event >> 8) & 0xff;
/*TODO*///		int vector = irq_event >> 16;
/*TODO*///
/*TODO*///		LOG(("cpu_empty_event_queue %d,%d,%d\n",cpunum,irqline,state));
/*TODO*///
...
/*TODO*///	cpu_set_irq_line_and_vector(cpunum, irqline, state, vector);
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*///void cpu_set_irq_line_and_vector(int cpunum, int irqline, int state, int vector)
/*TODO*///{
/*TODO*///	INT32 irq_event = (state & 0xff) | ((irqline & 0xff) << 8) | (vector << 16);
/*TODO*///	int event_index = irq_event_index[cpunum]++;
/*TODO*///
/*TODO*///	LOG(("cpu_set_irq_line(%d,%d,%d,%02x)\n", cpunum, irqline, state, vector));
/*TODO*///
/*TODO*///	/* enqueue the event */
/*TODO*///	if (event_index < MAX_IRQ_EVENTS)
/*TODO*///	{
/*TODO*///		irq_event_queue[cpunum][event_index] = irq_event;
/*TODO*///		
/*TODO*///		/* if this is the first one, set the timer */
/*TODO*///		if (event_index == 0)
/*TODO*///			timer_set(TIME_NOW, cpunum, cpu_empty_event_queue);
/*TODO*///	}
/*TODO*///	else
/*TODO*///		logerror("Exceeded pending IRQ event queue on CPU %d!\n", cpunum);
/*TODO*///}
/*TODO*///
/*TODO*///
/*TODO*///
